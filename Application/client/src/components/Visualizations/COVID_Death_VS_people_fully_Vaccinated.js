...
export default function TreemapFullVax(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "COVID_case_VS_people_fully_Vaccinated"
        let svgName = "COVID_case_VS_people_fully_Vaccinated"
        ...
        var generateColor = d3.scaleLinear()
            .domain([2, 105])
            .range(colors.parentColor && colors.childrenColor ? [colors.parentColor, colors.childrenColor] : ["#D4F1F4", "#05445E"])
            .clamp(true);
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(freedom_score_csv).then( function(data_input1) {
                    ...
                    filteredScores.map(obj1 => {
                        ...
                        console.log({name : matchingObj["location"], value :matchingObj["total_deaths_per_million"],Old:matchingObj['people_fully_vaccinated_per_hundred']})


                        sorted_data.push({name : matchingObj["location"], value :matchingObj["total_deaths_per_million"],Old:matchingObj['people_fully_vaccinated_per_hundred']})
                    });
