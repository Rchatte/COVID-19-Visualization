...
export default function TreemapFreedomCase(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        console.log(filters);
        const colors = { barColor: filters.color1, parentColor: filters.color1, childrenColor: filters.color2 };
        ...
        let id = "CountrysFreedomImpactOnCovidCases"
        let svgName = "CountrysFreedomImpactOnCovidCases"
