...
export default function TreemapGDPDeaths(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "GDPVsCovidDeaths"
        let svgName = "GDPVsCovidDeaths"
        ...
        function DrawTreemap() {
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(gdp_csv).then( function(data_input1) {
                    ...
                    let blacklist = ["NULL","EUU","HIC","LIC","LMC","NAC","UMC","WLD"]
                    ...
                    filteredScores.map(obj1 => {
                        ...
                        if (matchingObj){
                            console.log({name : matchingObj["location"], value : matchingObj["new_deaths"],GDP:obj1['2021']})
                            sorted_data.push({name : matchingObj["location"], value : matchingObj["new_deaths"],GDP:obj1['2021']})
