...
export default function TreemapHappinessMort(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "Happiness_vs_Mortality_Rate_Treemap"
        let svgName = "Happiness_vs_Mortality_Rate_Treemap"
                ...
                d3.csv(happiness_csv).then( function(data_input1) {
                    ...
                    filteredScores.map(obj1 => {
                        ...
                        if(matchingObj){
                            ...
                            sorted_data.push({name : matchingObj["location"], value: mort, Happiness : obj1["Happiness score"]});
                        }
