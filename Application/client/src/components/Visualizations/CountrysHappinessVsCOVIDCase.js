...
import happiness_csv from "./happiness_data_Appendix_2_Data_for_Figure_2.1.csv"
...
export default function TreemapHappinessScore(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "CountrysHappinessVsCOVIDCase"
        let svgName = "CountrysHappinessVsCOVIDCase"
        ...
        function DrawTreemap() {
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(happiness_csv).then( function(data_input1) {
                    ...
                    const filteredScores = data_input1.filter(obj => !blacklist.includes(obj.Country));

                    filteredScores.map(obj1 => {
                        let matchingObj = data.find(obj2 => obj1["Country"] === obj2["location"]);
                        if (matchingObj){
                            console.log({name : obj1["Country"], value : matchingObj["total_cases_per_million"],Happiness:obj1["Happiness score"]})
                            sorted_data.push({name : obj1["Country"], value : matchingObj["total_cases_per_million"],Happiness:obj1["Happiness score"]})
