...
export default function TreemapInternetCases(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "PercentUsingInternetvsCovidCases"
        let svgName = "PercentUsingInternetvsCovidCases"
        ...
        function DrawTreemap() {
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(internet_csv).then( function(data_input1) {
                    ...
                    let blacklist = ["", "OWID_WRL","NULL"]



                    const filteredScores = data_input1.filter(obj => obj.Year === "2020" && !blacklist.includes(obj.Code));
                ...
                var root = d3.hierarchy(sorted_data).sort(function (a, b) {
                    return b.data.Internet - a.data.Internet
                });
