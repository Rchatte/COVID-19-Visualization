...
import gdp_csv from "./API_NY.GDP.MKTP.CD_DS2_en_csv_v2_4701247.csv"
...
export default function TreemapGDPVaccinations(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "CountrysGDPAffectOnVaccinationsPerHundered"
        let svgName = "CountrysGDPAffectOnVaccinationsPerHundered"
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(gdp_csv).then( function(data_input1) {
                    ...
                    filteredScores.map(obj1 => {
                        ...
                        if (matchingObj){
                            console.log({name : matchingObj["location"], value : matchingObj["total_vaccinations_per_hundred"],GDP:obj1['2021']})
                            sorted_data.push({name : matchingObj["location"], value : matchingObj["total_vaccinations_per_hundred"],GDP:obj1['2021']})
                        }
                        });
