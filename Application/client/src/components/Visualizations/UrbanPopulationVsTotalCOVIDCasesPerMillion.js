...
export default function TreemapUrbanPop(props) {
    ...
    */}
    ...
    function setUP(props, svgRef) {
        ...
        let id = "UrbanPopulationVsTotalCOVIDCasesPerMillion"
        let svgName = "UrbanPopulationVsTotalCOVIDCasesPerMillion"
        ...
        var generateColor = d3.scaleLinear()
            .domain([372, 653246])
            .range(colors.parentColor && colors.childrenColor ? [colors.parentColor, colors.childrenColor] : ["#DAA06D", "#7B3F00"])
            .clamp(true);
            ...
            d3.csv(temp_url).then(function (data) {
                ...
                d3.csv(urb_csv).then( function(data_input1) {
                    ...
                    filteredScores.map(obj1 => {
                        ...
                        if (matchingObj){
                            console.log({name : matchingObj["location"], value : matchingObj["total_cases_per_million"],UrbanPop:obj1['2021']})
                            sorted_data.push({name : matchingObj["location"], value : matchingObj["total_cases_per_million"],UrbanPop:obj1['2021']})
